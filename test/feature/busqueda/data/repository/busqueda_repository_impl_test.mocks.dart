...
// in cocinando_con_flow/test/feature/busqueda/data/repository/busqueda_repository_impl_test.dart.
...
/// A class which mocks [BusquedaApiService].
///
/// See the documentation for Mockito's code generation for more information.
class MockBusquedaApiService extends _i1.Mock
    implements _i2.BusquedaApiService {
  MockBusquedaApiService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<List<_i4.RecetaModel>> buscarRecetasPorNombre(String? nombre) =>
      (super.noSuchMethod(
        Invocation.method(
        ...
        returnValue:
            _i3.Future<List<_i4.RecetaModel>>.value(<_i4.RecetaModel>[]),
      ) as _i3.Future<List<_i4.RecetaModel>>);
}
...
class MockRecetasCacheService extends _i1.Mock
    implements _i6.RecetasCacheService {
  MockRecetasCacheService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<List<_i7.RecetaEntity>?> obtenerRecetasCache(String? key) =>
      (super.noSuchMethod(
        Invocation.method(
          #obtenerRecetasCache,
          [key],
        ),
        returnValue: _i3.Future<List<_i7.RecetaEntity>?>.value(),
      ) as _i3.Future<List<_i7.RecetaEntity>?>);

  @override
  _i3.Future<void> guardarRecetasCache(
    String? key,
    List<_i7.RecetaEntity>? recetas,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
          #guardarRecetasCache,
  ...
  @override
  _i3.Future<List<_i7.RecetaEntity>?> obtenerBusquedaCache(String? query) =>
      (super.noSuchMethod(
        Invocation.method(
